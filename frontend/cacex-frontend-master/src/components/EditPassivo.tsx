...
const EditPassivo: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const fetchPassivo = async () => {
            try {
                const response = await axios.get(`http://localhost:8000/fetch_passivo/${id}/`, {
                    headers: {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await axios.put(`http://localhost:8000/edit_passivo/${id}/`, {
                nome,
                valor: valorNumerico,
                circulante,
            }, {
            ...
            console.error("Erro ao editar passivo:", error);
        }
    };
    ...
    return (
        <div>
            <Header />
            <h1 className="text-4xl font-bold underline text-center mb-6 mt-5">Editar Passivo</h1>
